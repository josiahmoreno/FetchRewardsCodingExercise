    ...
    override suspend fun fetchJson(): Result<List<EventsNetworkItem>> {
        return Result.success(
            listOf(
                EventsNetworkItem(
                    id = 9,
                    description = "Meet with Lando Calrissian for capture of Han Solo and Leia.",
                ...
                EventsNetworkItem(
                    id = 8,
                    description = "In a Theed hangar bay, Darth Maul (an apprentice of the Sith Lord Sidious) " +
